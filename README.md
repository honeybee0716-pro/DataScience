...
***[ldg_v3_gen](https://github.com/honeybee0716-pro/DataScience/blob/main/Letter_digit_generator/ldg_v3_gen.py)*** is a command-line letters/digits generator based on ldg_v3 Conv-CVAE model. It simply loads the Conv-CVAE model and the corresponding weights (best) to produce the results.
...
[***Current HDD_v1***](https://github.com/honeybee0716-pro/DataScience/blob/main/HappyDogDetection/HappyDogDetector_v1.ipynb) on a YouTube video (detecting only **Happy**)
